...
class Chest1Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Chest")
        self.font_title = ("TKDefaultFont", 26, "bold")
...
class Shoulder1Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Shoulders")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
        self.font_text2 = ("TKDefaultFont", 16)
...
class Back1Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Back")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
        self.font_text2 = ("TKDefaultFont", 16)
...
class Arms1Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Arms")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
        self.font_text2 = ("TKDefaultFont", 16)
...
class Legs1Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Legs")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
        self.font_text2 = ("TKDefaultFont", 16)
...
class Upper2Begin1(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Upper")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
...
class Lower2Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Lower")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
        ...
        img1 = Image.open("picture/gobletsquat.png")
        img2 = Image.open("picture/leglunge.png")
        img3 = Image.open("picture/sumosquat.png")
        img4 = Image.open("picture/stifflegdeadlift.png")
...
class Push3Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Push")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
...
class Pull3Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Pull")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
...
class Cardio4Begin(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Cardio")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
...
class ChestBack4Adv(Page):
    def __init__(self, parent):
        Page.__init__(self, parent, "Chest and Back")
        self.font_title = ("TKDefaultFont", 26, "bold")
        self.font_text = ("TKDefaultFont", 18, "bold")
