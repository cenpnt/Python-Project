...
try:
    ...
    messagebox.showerror("Error", "Pillow module is not installed. Please install it first.\nCommand: pip install Pillow")
    exit()
import webbrowser
...
class Explain(object):
    def __init__(self, second_window):
        ...
        filemenu.add_command(label="Back to Main Menu", command=self.back_main)
        filemenu.add_command(label="Exit", command=self.window3.quit)

        frame1 = Frame(self.window3)
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Explanation For Each Workout", font=self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
    ...
    def back_main(self):
        self.window3.destroy()
        self.third_window.second_window.window2.deiconify()

class ExplainChest(object):
    def __init__(self, third_window):
        ...
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Explanation For Each Muscle", font=self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
        Label(frame1, text="First Muscle Group", font= self.font_title, fg="#57a1f8").grid(row=2, column=1, sticky=NSEW)
        Label(frame1, text= "Chest", font= self.font_title, fg="#57a1f8").grid(row=3, column=1, sticky=NSEW)
...
class ExplainShoulders(object):
    def __init__(self, fourth_window):
        ...
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Second Muscle Group", font= self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
        Label(frame1, text= "Shoulders", font= self.font_title, fg="#57a1f8").grid(row=2, column=1, sticky=NSEW)
...
class ExplainBack(object):
    def __init__(self, fifth_window):
        ...
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Third Muscle Group", font= self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
        Label(frame1, text= "Back", font= self.font_title, fg="#57a1f8").grid(row=2, column=1, sticky=NSEW)
...
class ExplainArms(object):
    def __init__(self, sixth_window):
        ...
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Fourth Muscle Group", font= self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
        Label(frame1, text= "Arms", font= self.font_title, fg="#57a1f8").grid(row=2, column=1, sticky=NSEW)
...
class ExplainLegs(object):
    def __init__(self, seventh_window):
        ...
        frame1.pack(padx=10, pady=10)
        Label(frame1, text="Fifth Muscle Group", font= self.font_title, fg="#57a1f8").grid(row=1, column=1, sticky=NSEW)
        Label(frame1, text= "Legs", font= self.font_title, fg="#57a1f8").grid(row=2, column=1, sticky=NSEW)
    ...
    def back_main(self):
        self.window8.destroy()
        self.eight_window.seventh_window.window7.destroy()
        self.eight_window.seventh_window.sixth_window.window6.destroy()
        self.eight_window.seventh_window.sixth_window.fifth_window.window5.destroy()
        self.eight_window.seventh_window.sixth_window.fifth_window.fourth_window.window4.destroy()
        self.eight_window.seventh_window.sixth_window.fifth_window.fourth_window.third_window.window3.destroy()
        self.eight_window.seventh_window.sixth_window.fifth_window.fourth_window.third_window.second_window.window2.deiconify()